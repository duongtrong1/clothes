...
import com.smartosc.ecommerce.clothes.service.*;
import com.smartosc.ecommerce.clothes.util.MailConstructor;
import com.smartosc.ecommerce.clothes.util.USConstants;
...
public class CheckoutController {
	...
	public String setShippingAddress(@RequestParam("userShippingId") Long userShippingId, Principal principal,
		...
		if (!userShipping.getUser().getUserId().equals (user.getUserId())) {
			return "badRequestPage";
		} else {
			shippingAddressService.setByUserShipping(userShipping, shippingAddress);
			List<CartItem> cartItemList = cartItemService.findByShoppingCart(user.getShoppingCart());
